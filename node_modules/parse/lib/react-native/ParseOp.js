...
var Op = exports.Op = function () {
  ...
  return (0, _createClass2.default)(Op, [{
    key: "applyTo",
    value: function () {}
  }, {
    key: "mergeWith",
...
var SetOp = exports.SetOp = function (_Op) {
  function SetOp(value) {
    ...
    _this = _callSuper(this, SetOp);
    _this._value = value;
    return _this;
  }
  (0, _inherits2.default)(SetOp, _Op);
  return (0, _createClass2.default)(SetOp, [{
    key: "applyTo",
    value: function () {
      return this._value;
    }
...
var UnsetOp = exports.UnsetOp = function (_Op2) {
  function UnsetOp() {
    ...
    return _callSuper(this, UnsetOp, arguments);
  }
  (0, _inherits2.default)(UnsetOp, _Op2);
  return (0, _createClass2.default)(UnsetOp, [{
    key: "applyTo",
    value: function () {
      return undefined;
    }
...
var IncrementOp = exports.IncrementOp = function (_Op3) {
  function IncrementOp(amount) {
    ...
    _this2 = _callSuper(this, IncrementOp);
  ...
  return (0, _createClass2.default)(IncrementOp, [{
    key: "applyTo",
...
var RelationOp = exports.RelationOp = function (_Op7) {
  function RelationOp(adds, removes) {
    ...
    _this6 = _callSuper(this, RelationOp);
    _this6._targetClassName = null;
    if (Array.isArray(adds)) {
      _this6.relationsToAdd = (0, _unique.default)(adds.map(_this6._extractId, _this6));
    }
    if (Array.isArray(removes)) {
      _this6.relationsToRemove = (0, _unique.default)(removes.map(_this6._extractId, _this6));
    }
    return _this6;
  }
  (0, _inherits2.default)(RelationOp, _Op7);
  return (0, _createClass2.default)(RelationOp, [{
    key: "_extractId",
    value: function (obj) {
